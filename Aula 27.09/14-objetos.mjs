...
console.log(`Área de uma elipse de 20x10: (${JSON.stringify(forma4)}): ${calcArea(forma4)}`)
console.log(`Área de uma elipse de 20x10: (${JSON.stringify(forma5)}): ${calcArea(forma5)}`)
...
/*
    ...
    Os igredientes das receitas variam, mas todas sairão com a forma redonda
